...
export class ComparisonComponent implements OnInit {
  ...
  public results: any;
  public prices: any;
  public singleid: { quotes: { USD: { price: number; market_cap: number; percent_change_1h: number; percent_change_7d: number; percent_change_24h: number; }; }; name: string; };
  public singleid2: { quotes: { USD: { price: any; market_cap: number; percent_change_1h: number; percent_change_7d: number; percent_change_24h: number; }; }; name: string; };
  ...
  ngOnInit() {
    ...
    this._crypto.getAllCurrency().subscribe((res: { [x: string]: any; }) => {
      ...
      this.price = this.singleid.quotes.USD.price;
      this.marketCap = this.singleid.quotes.USD.market_cap;
      this.percent_change_1h = this.singleid.quotes.USD.percent_change_1h;
      this.percent_change_7d = this.singleid.quotes.USD.percent_change_7d;
      this.percent_change_24h = this.singleid.quotes.USD.percent_change_24h;
      ...
      this._crypto.getAllCurrency().subscribe((res: { [x: string]: any; }) => {
        ...
        this.prices = this.singleid2.quotes.USD.price;
        this.marketCaps = this.singleid2.quotes.USD.market_cap;
        this.percent_change_1hs = this.singleid2.quotes.USD.percent_change_1h;
        this.percent_change_7ds = this.singleid2.quotes.USD.percent_change_7d;
        this.percent_change_24hs = this.singleid2.quotes.USD.percent_change_24h;
